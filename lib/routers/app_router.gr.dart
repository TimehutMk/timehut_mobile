...
abstract class $AppRouter extends _i8.RootStackRouter {
  ...
  final Map<String, _i8.PageFactory> pagesMap = {
    ...
    ShiftsRoute.name: (routeData) {
      final args = routeData.argsAs<ShiftsRouteArgs>(
          orElse: () => const ShiftsRouteArgs());
      return _i8.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i6.ShiftsScreen(key: args.key),
      );
    },
...
/// generated route for
/// [_i6.ShiftsScreen]
class ShiftsRoute extends _i8.PageRouteInfo<ShiftsRouteArgs> {
  ShiftsRoute({
    _i9.Key? key,
    List<_i8.PageRouteInfo>? children,
  }) : super(
          ShiftsRoute.name,
          args: ShiftsRouteArgs(key: key),
          initialChildren: children,
        );

  static const String name = 'ShiftsRoute';

  static const _i8.PageInfo<ShiftsRouteArgs> page =
      _i8.PageInfo<ShiftsRouteArgs>(name);
}

class ShiftsRouteArgs {
  const ShiftsRouteArgs({this.key});

  final _i9.Key? key;

  @override
  String toString() {
    return 'ShiftsRouteArgs{key: $key}';
  }
}
